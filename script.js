let githubUser = 'luangprom'
let repo = 'uangprom.github.io'
let imgFolder = 'imges'
...
async function login() {
    ...
    const response = await fetch('https://script.google.com/macros/s/AKfycbwCdQZueXWFexU__WQ9nOqSA-bson4lSbhESCQWzo8e1GEI99eMNERUMJpHsR7_HQaqww/exec');
